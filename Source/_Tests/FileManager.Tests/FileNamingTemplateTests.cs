...
{
	static readonly PropertyTagCollection<PropertyClass1> props1 = new()
	{
	...
	static readonly PropertyTagCollection<PropertyClass2> props2 = new()
	{
		{ new TemplateTag { TagName = "item1" }, i => i.Item1 },
		{ new TemplateTag { TagName = "item2" }, i => i.Item2 },
		{ new TemplateTag { TagName = "item3" }, i => i.Item3 },
	...
	static readonly PropertyTagCollection<PropertyClass3> props3 = new(true, GetVal)
	{
